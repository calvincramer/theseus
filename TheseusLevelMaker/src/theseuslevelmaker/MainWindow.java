...
public class MainWindow extends javax.swing.JFrame {
    ...
    public MainWindow() {
        ...
        initComponents();
        table.setModel(new ColorTableModel());
        ...
        for (int i = 0; i < table.getModel().getRowCount(); i+= 2) {
            table.setRowHeight(i, SW);
        }
        for (int i = 0; i < table.getColumnCount(); i += 2) {
            table.getColumnModel().getColumn(i).setPreferredWidth(SW);
        ...
        for (int x = 0; x < 27; x++) {
            ...
            cr.set(x, 0);
            table.getColumnModel().getColumn(x).setCellRenderer(cr);
        }
        this.setTitle("Make a Level");
    ...
    private void initComponents() {
        ...
        table.setSelectionBackground(java.awt.Color.red);
    ...
    private void tableMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMousePressed
        ...
        CustomRenderer cr = new CustomRenderer();
        cr.set(column, row);
        table.getColumnModel().getColumn(column).setCellRenderer(cr);
